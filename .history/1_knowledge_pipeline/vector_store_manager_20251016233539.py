...
# --- تحديد المسارات الأساسية أولاً ---
# هذا هو التعريف الذي يجب أن يأتي في البداية
BASE_DIR = os.path.dirname(os.path.abspath(__file__)) 

# --- تحميل متغيرات البيئة من ملف .env بشكل صريح ---
# الآن يمكننا استخدام BASE_DIR لبناء المسار الصحيح إلى ملف .env
PROJECT_ROOT = os.path.abspath(os.path.join(BASE_DIR, ".."))
DOTENV_PATH = os.path.join(PROJECT_ROOT, '.env')
load_dotenv(dotenv_path=DOTENV_PATH)
logging.info(f"محاولة تحميل متغيرات البيئة من: {DOTENV_PATH}")
